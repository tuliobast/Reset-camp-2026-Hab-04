...
const PARTICIPANTS = [
  { id: 1, name: "Aime Calderon", role: "Edad: 30", img: "./Aime_Calderon-removebg-preview.png" },
  { id: 2, name: "Aylen Alvarado", role: "Edad: 20", img: "./Aylen_Alvarado-removebg-preview.png" },
  { id: 3, name: "Brenda Laguia", role: "Edad: 26", img: "./silueta_2-removebg-preview.png" },
  { id: 4, name: "Eliana Moreno", role: "Edad: 27", img: "./Eliana_Moreno-removebg-preview.png" },
  { id: 5, name: "Gabriela Alonzo", role: "Edad: 23", img: "./silueta_2-removebg-preview.png" },
  ...
  { id: 13, name: "Sofia Lopez", role: "Edad: 22", img: "./Sofia_Lopez-removebg-preview.png" },
  { id: 14, name: "Solange Gonzalez", role: "Edad: 31", img: "./Solange_Gonzalez-removebg-preview.png" },
  { id: 15, name: "Victoria Heredia", role: "Edad: 30", img: "./Victoria_Heredia-removebg-preview.png" },
];
